...
{  int i;
	...
	unsigned char str1 [ ] = "mzulukhandapa";
       
	for(i=0;str1[i]!=0;i++)  /* Send each char of string till the NULL */
	{
		LCD_Char (str1[i]);  /* Call LCD data write */
	}
	...
	for(i=0;str2[i]!=0;i++)  /* Send each char of string till the NULL */
	{
		LCD_Char (str2[i]);  /* Call LCD data write */
	}
